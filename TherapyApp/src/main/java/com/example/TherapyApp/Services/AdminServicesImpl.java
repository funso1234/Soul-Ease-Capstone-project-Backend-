...
public class AdminServicesImpl implements AdminServices {
    ...
    public List<RecommendedTherapistResponse> getRecommendedTherapists(Long userId) {
        ...
        Specialization preferredSpecialization = user.getPreferredSpecialization();
...
//        }
        List<Therapist> therapists = therapistRepository.findBySpecializations(preferredSpecialization);
